    ...
    function saveItem($data)
    {
        ...
        $newConf = [
            ...
            'availability' => [
                ...
                'timeIncrDuration' => [
                    'value' => intval(sanitize_text_field($postData['availability']['timeIncrDuration']['value'])),
                    'unit' => sanitize_text_field($postData['availability']['timeIncrDuration']['unit']) == 'default' ?
                        sanitize_text_field($postData['general']['durationUnit']) : sanitize_text_field($postData['availability']['bufferPeriod']['unit']),
                ],
